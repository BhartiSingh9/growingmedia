        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 text-sm">
              <li>
                <Link to="/services#web-dev" className="hover:text-blue-400">
                  Web Development
                </Link>
              </li>
              <li>
                <Link to="/services#seo" className="hover:text-blue-400">
                  SEO
                </Link>
              </li>
              <li>
                <Link to="/services#social" className="hover:text-blue-400">
                  Social Media
                </Link>
              </li>
            </ul>
